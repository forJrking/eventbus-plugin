...
import com.madrapps.eventbus_nav.ui.CompositeActiveComponent;
import com.madrapps.eventbus_nav.ui.PingEDT;
import com.madrapps.eventbus_nav.ui.ShowUsagesTableCellRenderer;
...
public class ShowUsagesAction extends AnAction implements PopupAction {
    ...
    public ShowUsagesAction() {
        ...
        myUsageViewSettings = new UsageViewSettings(false, false, false, false, false, false);
